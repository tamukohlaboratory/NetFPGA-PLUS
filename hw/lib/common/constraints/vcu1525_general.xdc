...
create_generated_clock -name sys_clk -source [get_pins u_clk_wiz_ip/inst/mmcme4_adv_inst/CLKIN1] -master_clock [get_clocks sysclk_p] [get_pins u_clk_wiz_1/inst/mmcme4_adv_inst/CLKOUT0]
